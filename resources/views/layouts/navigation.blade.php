<nav id="marketing-banner" tabindex="-1"
class="fixed z-50  w-[calc(100%-2rem)]  -translate-x-1/2    lg:max-w-7xl left-1/2 top-2  border-gray-200 rounded-lg shadow-md bg-gray-50 dark:bg-gray-800 dark:border-gray-700 shadow-indigo-300">
