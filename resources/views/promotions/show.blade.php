            ...
            <div
                ...
                <div class="">
                    ...
                    <div
                        ...
                        <a href="{{route('branches.promotions', $promotion->branch->name)}}" class="flex items-start p-1 text-white border-b border-white rounded cursor-pointer text-md focus:outline-none hover:bg-indigo-600">
