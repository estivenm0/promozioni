<x-app-layout>
    <section class="text-gray-600 xl:px-36 ">
        <div class="container flex flex-col p-3 m-auto mx-auto rounded-md bg-gray-200 md:flex-row">
            <div
                ...
                <div class="">
                    ...
                    <div
                        ...
                        <a href="{{route('branches.promotions', $promotion->branch->name)}}"
                            class="flex items-start p-1 text-white border-b border-white rounded cursor-pointer text-md focus:outline-none hover:bg-indigo-600">
